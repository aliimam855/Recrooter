...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Register | Recrooter</title>
    ...
    <body class="authentication-bg">
        <div class="p-3 mb-3 "><h1 class="mx-5" style="text-align: center"><b>Recruitment Management System</b></h1></div>
        <div class="home-btn d-none d-sm-block">
            <a href="{{ route('home') }}" class="text-dark"><i class="mdi mdi-home-variant h2"></i></a>
        </div>
                            ...
                            <div class="card-body p-4"> 
                                ...
                                <div class="p-2 mt-4">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="role_id">User Role As</label>
                                            
                                            <select class="form-select" aria-label="Default select example" @error('role_id') is-invalid @enderror name="role_id" value="{{ old('role_id') }}" >
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="role" class="col-md-4 col-form-label text-md-end">{{ __('Role_Type') }}</label>
