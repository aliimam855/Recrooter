                  ...
                  <div class="container-fluid">
                      ...
                      <div class="row mb-4 mt-3">
                        ...
                        <div class="col-xl-8">
                            <div class="card mb-0">
                              <div class="card-body">
                                <form class="form-horizontal" action="{{ route('employee.update.profile', Auth::user()->id) }}" method="post" enctype="multipart/form-data">
                                  @csrf
                                  ...
                                  <br><br>
                                  <button type="submit" class="btn btn-md btn-primary" style="float: right;">Update</button>
