                              ...
                              <div class="page-title-box d-flex align-items-center justify-content-between">
                                  ...
                                  <div class="page-title-right">
                                      <ol class="breadcrumb m-0">
                                          ...
                                          <li class="breadcrumb-item"><a href="{{ route('hm.applicant.detail',$phone_interview->candidate->id) }}">{{ $phone_interview->candidate->name }}</a></li>
                                ...
                                <div class="card-body mx-3">
                                    ...
                                    <div class="row mb-2">
                                      ...
                                      <div class="col-sm-9 mt-2">   
                                       {{ $phone_interview->candidate->name }}
                                      </div>
                                  </div>
                                  <div class="row mb-2">
