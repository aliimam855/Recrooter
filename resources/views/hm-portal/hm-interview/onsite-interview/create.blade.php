                              ...
                              <div class="page-title-box d-flex align-items-center justify-content-between">
                                  ...
                                  <div class="page-title-right">
                                      <ol class="breadcrumb m-0">
                                          ...
                                          <li class="breadcrumb-item"><a href="{{ route('hm.applicant.detail',$interview->candidate->id) }}">{{ $interview->candidate->name }}</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="card mx-3 mt-3">
                                <div class="card-body mx-3">
                                    <form action="{{ route('hm.onsite.interview.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf

                                    <div class="mb-3">
                                        <div class="col-md-8">
                                         <label class="form-label"><b>Onsite Interview with :</b>   {{ $interview->candidate->name }}  </label>

                                         <input type="text" name="candidate_id" class="form-control" value="{{ $interview->candidate_id }}" hidden>
                                         </div>
                                        </div>
                                        <div class="mb-3">
                                            <div class="col-md-4">
