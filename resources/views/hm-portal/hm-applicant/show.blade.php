                                              ...
                                              <div class="mb-3">
                                               ...
                                               {{-- <div class="card"> --}}
                                                ...
                                                <div class="card-body ">
                                                   ...
                                                   <form class="custom-validation" action="{{ route('hm.applicant.detail.update',$candidate->id) }}" method="POST" enctype="multipart/form-data">
                                                   @csrf 
                                                  ...
                                                  <div class="mb-3">
                                                   ...
                                                   <div class="mb-3">
                                                    ...
                                                    {{-- <label class="form-label"><h6><b>Sub-Status :</b> </label>      --}}
                                                      ...
                                                      name="sub_status" >
                                                       <option  selected>{{ $candidate->sub_status }}</option>
                                                  ...
                                                  <div class="mb-3">
                                                    ...
                                                    {{-- <label class="form-label"><h6><b>Sub-Status :</b> </label>      --}}
                                                      ...
                                                      name="other_interviewer" >
                                                       <option  selected>{{ $candidate->other_interviewer }}</option>
