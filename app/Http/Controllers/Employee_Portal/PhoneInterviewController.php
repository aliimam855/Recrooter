...
class PhoneInterviewController extends Controller
{
      ...
      $date = Carbon::now();
        //  dd($phone_interview);
         ...
         return view('employee-portal.employee-interview.phone-interview.create',compact('interview','phone_interview'));
   ...
   public function store(Request $request)
   {
    ...
    // dd($phone_interview); 
     ...
     return view('employee-portal.employee-interview.phone-interview.show', compact('phone_interview'));
